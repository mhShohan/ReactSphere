...
const DataVisualization: React.FC = () => {
  ...
  const renderChart = () => {
    switch (chartType) {
      ...
      case 'pie':
        return <Pie data={pieChartData as any} options={options} />;
      case 'doughnut':
        return <Doughnut data={pieChartData as any} options={options} />;
      case 'polar':
        return <PolarArea data={pieChartData as any} options={options} />;
      case 'radar':
